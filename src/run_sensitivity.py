...
from src.audit_pre_sensitivity import participant_index
...
def load_model(artifact: dict, checkpoint_path: Path, personalized: bool):
...
def main() -> None:
    ...
    model = load_model(artifact, args.checkpoint, args.personalized)
